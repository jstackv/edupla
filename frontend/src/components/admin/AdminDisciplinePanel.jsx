  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, flexWrap: 'wrap' }}>
        <div className="aop-hero-icon" style={{ width: 42, height: 42, background: 'linear-gradient(135deg,#c2410c,#7c2d12)', border: 'none', boxShadow: '0 6px 16px color-mix(in srgb, #c2410c 40%, transparent)' }}>
      ...
      {detail && (() => {
        ...
        >
          <div style={{ borderRadius: 20, border: '1px solid var(--card-border)', background: 'var(--card-bg)', width: '100%', maxWidth: 680, maxHeight: '85vh', display: 'flex', flexDirection: 'column', overflow: 'hidden', boxShadow: '0 24px 60px rgba(0,0,0,0.3)' }} onClick={e => e.stopPropagation()}>
            <div style={{ padding: '18px 22px', borderBottom: '1px solid var(--card-border)', display: 'flex', alignItems: 'center', gap: 12, background: 'color-mix(in srgb, #c2410c 5%, var(--card-bg))' }}>
              <div style={{ width: 36, height: 36, borderRadius: 10, background: 'linear-gradient(135deg,#c2410c,#7c2d12)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                ...
                <>
                  ...
                  <div style={{ padding: '16px 20px 4px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: 10 }}>
                    {(() => {
                      ...
                      const stats = [
                        { label: 'Students', value: rows.length, icon: Users, color: '#c2410c' },
