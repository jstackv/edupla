...
/*
 * Animated Edupla brand mark — v4, "Ember & Current".
 *
 ...
 *
 * Same visual design as public/favicon-v2.svg (slate badge, a faceted
 * prism-shard highlight, a teal-tinted vignette, an embossed "E" monogram
 * that doubles as an ascending bar chart, a dotted teal->orange "growth
 * path" running to a dark-orange four-point achievement spark with a teal
 * core) with several subtle looping animations layered on top:
 ...
 *   - a single tiny teal particle orbiting the sparkle, like a stray idea
 *     catching the light
      ...
      <svg viewBox="0 0 32 32" aria-hidden="true">
        <defs>
          ...
          <filter id={ids.glyphShadow} x="-40%" y="-40%" width="180%" height="180%">
            <feDropShadow dx="0" dy="0.9" stdDeviation="1" floodColor="#04070C" floodOpacity="0.45" />
          </filter>

          <filter id={ids.lift} x="-40%" y="-40%" width="180%" height="180%">
            <feDropShadow dx="0" dy="1.2" stdDeviation="1.4" floodColor="#04070C" floodOpacity="0.45" />
          </filter>
        </defs>
        ...
        <g className="em-badge" filter={`url(#${ids.lift})`}>
          ...
          <circle className="em-orbit" cx="23.1" cy="10.1" r="0.42" fill="#2DD4BF" fillOpacity="0.95" />
          ...
          <g className="em-sparkle" filter={`url(#${ids.glyphShadow})`}>
            ...
            <circle cx="23.1" cy="10.1" r="0.5" fill="#2DD4BF" />
          </g>
        </g>
      </svg>
    </span>
