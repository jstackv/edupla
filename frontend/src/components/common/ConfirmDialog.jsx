        ...
        <div className="p-6">
          ...
          <div className="flex gap-3">
            ...
            <button onClick={onConfirm} disabled={loading}
              className="flex-1 justify-center inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold transition-all bg-red-600 hover:bg-red-700 text-white disabled:opacity-50">
