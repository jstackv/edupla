...
export default function ShareAssessmentModal({ assessment, onClose, onShared }) {
  ...
  return (
    <Modal
      ...
      icon={Send} accent="#ea580c" accent2="#ea580c"
    >
      <div className="space-y-4">
        ...
        {isReshare && (
          <p className="qm-note text-xs px-3 py-2 rounded-xl" style={{ background: 'rgba(234, 88, 12,0.08)', border: '1px solid rgba(234, 88, 12,0.2)', color: 'var(--text-secondary)' }}>
