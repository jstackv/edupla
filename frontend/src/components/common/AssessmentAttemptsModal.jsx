...
const STATUS_STYLE = {
  ...
  submitted:      { label: 'Submitted',       color: '#c2410c', bg: 'rgba(194, 65, 12,0.12)' },
          ...
          >
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              ...
              {att.status !== 'in_progress' && (
                <button onClick={() => onViewAttempt(att.id)} className="font-semibold flex items-center gap-1 transition-colors duration-150 hover:opacity-80" style={{ color: '#c2410c' }}>
      ...
      {gradingAttemptId ? (
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3 assessment-stagger">
            {[
              { label: 'Students', value: stats.total, color: '#c2410c', icon: Users },
              ...
              { label: 'Attempts submitted', value: stats.totalAttempts, color: '#c2410c', icon: Repeat },
            ].map((it, i) => (
