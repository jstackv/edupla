...
const FEATURES_KEYS = [
  { labelKey: 'auth.features.smartClassrooms', icon: '📚', color: '#c2410c' },
...
const ACCESS_INFO = [
  { icon: '🔐', textKey: 'auth.accessInfo.encrypted',  default: 'Encrypted sessions',      color: '#c2410c' },
...
function ParticleBg({ dark }) {
  ...
  useEffect(() => {
    ...
    const accentR = dark ? '249,115,22' : '234,88,12';
    const draw = () => {
...
function Ticker({ dark }) {
  ...
  return (
    <div style={{
      ...
      background: dark ? 'rgba(255,255,255,0.05)' : 'rgba(194, 65, 12,0.05)',
      border: `1px solid ${dark ? 'rgba(255,255,255,0.08)' : 'rgba(194, 65, 12,0.12)'}`,
...
export default function Login() {
  ...
  const C = {
    ...
    panelBorder: dark ? 'rgba(255,255,255,0.07)'  : 'rgba(194, 65, 12,0.12)',
    card:        dark ? 'rgba(10,13,26,0.94)'     : '#ffffff',
    cardBorder:  dark ? 'rgba(255,255,255,0.08)'  : 'rgba(194, 65, 12,0.14)',
    cardShadow:  dark ? '0 40px 100px rgba(0,0,0,0.65)' : '0 32px 80px rgba(194, 65, 12,0.16)',
    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ep-accent-line {
          height: 2.5px;
          background: linear-gradient(90deg,#9a3412,#9a3412,#0ea5e9,#9a3412,#9a3412);
        ...
        .ep-logo-badge {
          ...
          display: flex; align-items: center; justify-content: center;
          box-shadow: 0 0 0 1px rgba(194, 65, 12,0.35), 0 8px 22px rgba(194, 65, 12,0.4);
          transition: transform 0.35s cubic-bezier(0.22,1,0.36,1), box-shadow 0.35s;
        }
        .ep-logo-badge:hover { transform: rotate(-6deg) scale(1.06); box-shadow: 0 0 0 1px rgba(194, 65, 12,0.5), 0 12px 30px rgba(194, 65, 12,0.55); }

        .ep-submit {
          width: 100%; padding: 14px;
          border-radius: 15px; border: none;
          background: linear-gradient(135deg, #9a3412 0%, #c2410c 45%, #9a3412 100%);
        ...
        .ep-submit:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 16px 40px rgba(194, 65, 12,0.55); }
        ...
        .ep-back:focus-visible { outline: 2px solid #c2410c; outline-offset: 2px; }
      ...
      <div className="ep-root" style={{ background: C.bg }}>
        ...
        <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
          <div className="ep-mesh-a" style={{ position: 'absolute', top: '-14%', left: '4%', width: 520, height: 520, borderRadius: '50%', background: 'radial-gradient(circle,rgba(194, 65, 12,0.16),transparent 70%)', filter: 'blur(95px)' }} />
        ...
        >
          ...
          <div className="ep-grid-pattern" style={{ position: 'absolute', inset: 0, backgroundImage: `radial-gradient(circle,${dark ? 'rgba(255,255,255,0.05)' : 'rgba(154, 52, 18,0.07)'} 1px, transparent 1px)`, backgroundSize: '22px 22px', opacity: 0.5, pointerEvents: 'none', maskImage: 'radial-gradient(ellipse 65% 55% at 50% 30%, black, transparent)', WebkitMaskImage: 'radial-gradient(ellipse 65% 55% at 50% 30%, black, transparent)' }} />
          <div style={{ position: 'absolute', width: 280, height: 280, top: -60, right: -60, borderRadius: '50%', background: 'radial-gradient(circle, rgba(194, 65, 12,0.12), transparent 70%)', pointerEvents: 'none' }} />
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '18px 0', position: 'relative', zIndex: 1 }}>
            ...
            <div style={{
              ...
              background: dark ? 'rgba(194, 65, 12,0.12)' : 'rgba(194, 65, 12,0.07)',
              border: '1px solid rgba(194, 65, 12,0.28)',
              fontSize: 11, fontWeight: 600, color: dark ? '#ea580c' : '#9a3412', letterSpacing: '0.04em',
            }}>
            ...
            <h1 style={{ margin: '0 0 14px' }}>
              ...
              <span style={{ display: 'block', fontFamily: "'Outfit',sans-serif", fontSize: 'clamp(1.9rem, 3.4vw, 2.7rem)', fontWeight: 900, lineHeight: 1.05, letterSpacing: '-0.04em', background: 'linear-gradient(135deg,#ea580c 0%,#ea580c 50%,#38bdf8 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
            ...
            <p style={{
              ...
              color: dark ? '#f97316' : '#9a3412', margin: '0 0 10px',
            }}>
              ...
              {FEATURES_KEYS.map((f, i) => (
                <div
                  ...
                  style={{
                    ...
                    border: `1px solid ${dark ? 'rgba(255,255,255,0.05)' : 'rgba(194, 65, 12,0.08)'}`,
                  }}
                  onMouseEnter={e => { e.currentTarget.style.borderColor = f.color + '45'; e.currentTarget.style.background = f.color + '0e'; }}
                  onMouseLeave={e => { e.currentTarget.style.borderColor = dark ? 'rgba(255,255,255,0.05)' : 'rgba(194, 65, 12,0.08)'; e.currentTarget.style.background = dark ? 'rgba(255,255,255,0.02)' : 'rgba(255,255,255,0.5)'; }}
                >
          ...
          <div style={{
            ...
            background: dark ? 'rgba(194, 65, 12,0.07)' : 'rgba(194, 65, 12,0.04)',
            border: `1px solid ${dark ? 'rgba(194, 65, 12,0.18)' : 'rgba(194, 65, 12,0.14)'}`,
          }}>
            <div style={{ position: 'absolute', top: 8, right: 12, fontSize: 46, color: '#c2410c', opacity: 0.08, fontFamily: 'Georgia,serif', lineHeight: 1, userSelect: 'none' }}>"</div>
            <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: 10.5, fontWeight: 700, color: dark ? '#f97316' : '#9a3412', margin: 0 }}>{t('auth.testimonialAuthor')}</p>
            </div>
          </div>
        </div>
        ...
        <div className="ep-right-panel" style={{ zIndex: 2 }}>
          ...
          <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', overflow: 'hidden', zIndex: 0 }}>
            <div style={{ position: 'absolute', width: 420, height: 420, top: -130, right: -110, borderRadius: '50%', background: dark ? 'radial-gradient(circle,rgba(194, 65, 12,0.1),transparent 68%)' : 'radial-gradient(circle,rgba(154, 52, 18,0.06),transparent 68%)' }} />
            <div style={{ position: 'absolute', width: 300, height: 300, bottom: -110, left: -60, borderRadius: '50%', background: dark ? 'radial-gradient(circle,rgba(154, 52, 18,0.08),transparent 68%)' : 'radial-gradient(circle,rgba(154, 52, 18,0.05),transparent 68%)' }} />
          </div>
          ...
          <div
            ...
            style={{ color: dark ? 'rgba(255,255,255,0.14)' : 'rgba(154, 52, 18,0.16)' }}
          >
            Edupla
          </div>
          ...
          <div className="ep-card-wrap" style={{ position: 'relative' }}>
            ...
            <div className="ep-ring-spin" style={{ top: '50%', left: '50%', width: 560, height: 560, transform: 'translate(-50%,-50%)', border: `1px dashed ${dark ? 'rgba(194, 65, 12,0.14)' : 'rgba(194, 65, 12,0.1)'}` }} />
            ...
            <div className="ep-badge-float2" style={{ position: 'absolute', bottom: -16, left: 20, zIndex: 2, padding: '8px 13px', borderRadius: 12, background: dark ? 'rgba(194, 65, 12,0.12)' : 'rgba(194, 65, 12,0.07)', border: '1px solid rgba(194, 65, 12,0.25)', backdropFilter: 'blur(12px)', display: 'flex', alignItems: 'center', gap: 7, boxShadow: '0 8px 24px rgba(194, 65, 12,0.15)' }}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#c2410c" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
              <span style={{ fontSize: 11, fontWeight: 700, color: dark ? '#ea580c' : '#9a3412', whiteSpace: 'nowrap' }}>{t('auth.trustStrip.systemAccess', '24/7 System Access')}</span>
            </div>
                    ...
                    <div>
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 7 }}>
                        ...
                        <button
                          ...
                          style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 11.5, color: dark ? '#f97316' : '#9a3412', fontWeight: 600, fontFamily: "'Outfit',sans-serif" }}
                        >
                ...
                <div className="ep-step">
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 18 }}>
                    <button
                      ...
                      style={{ color: C.text2, background: dark ? 'rgba(255,255,255,0.06)' : 'rgba(194, 65, 12,0.06)' }}
                    >
                  ...
                  <div style={{
                    ...
                    background: dark ? 'rgba(194, 65, 12,0.15)' : '#fed7aa',
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#c2410c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      <circle cx="12" cy="16" r="1" fill="#c2410c"/>
                    </svg>
                  </div>
