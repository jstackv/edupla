...
const TOKENS = {
  purple: '#f97316',
  purpleDark: '#ea580c',
  purpleGlass: 'rgba(249,115,22,0.08)',
  sky: '#0ea5e9',
  ...
  violet: '#f97316',
  violetGlass: 'rgba(249,115,22,0.08)',
};
...
const GLOBAL_STYLES = `
  ...
  .stat-card-glow:hover { box-shadow: 0 0 20px rgba(249,115,22,0.2); }
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4"
      ...
      <div className="w-full max-w-md rounded-2xl overflow-hidden"
        ...
        <div className="h-1 w-full" style={{ background: 'linear-gradient(90deg,#f97316,#f97316,#f97316)' }} />
        <div className="p-6">
          <div className="flex items-start justify-between mb-5">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0"
          ...
          <div className="flex items-center gap-3 rounded-xl p-3 mb-5"
            style={{ background: TOKENS.purpleGlass, border: '1px solid rgba(249,115,22,0.15)' }}>
          ...
          <div className="flex gap-3 mt-6">
            ...
            <button onClick={handleSubmit} disabled={saving}
              className="flex-1 px-4 py-2.5 rounded-xl text-sm font-bold text-white flex items-center justify-center gap-2"
              style={{ background: 'linear-gradient(135deg,#f97316,#ea580c)', boxShadow: '0 4px 14px rgba(249,115,22,0.35)', opacity: saving ? 0.7 : 1 }}>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-end p-3"
      ...
      <div className="w-full max-w-2xl h-full max-h-[calc(100vh-1.5rem)] flex flex-col rounded-2xl overflow-hidden"
        ...
        <div className="h-1 w-full flex-shrink-0" style={{ background: isActive ? 'linear-gradient(90deg,#f97316,#f97316,#ec4899)' : '#9ca3af' }} />
          ...
          {tabs.map(t => {
            ...
            return (
              <button key={t.id} onClick={() => setTab(t.id)}
                ...
                style={tab === t.id
                  ? { background: 'linear-gradient(135deg,#f97316,#ea580c)', color: '#fff', boxShadow: '0 2px 8px rgba(249,115,22,0.35)' }
                          ...
                          return (
                            <div key={t.id} className="flex items-center gap-3">
                              <AdminAvatar name={t.name} isActive={t.is_active !== false} size={28}
                                gradient={t.is_active !== false ? 'linear-gradient(135deg,#f97316,#f97316)' : undefined} />
                            ...
                            {!cls.enrolledStudents || cls.enrolledStudents.length === 0
                              ...
                              : cls.enrolledStudents.map(s => (
                                <div key={s.id} className="flex items-center gap-2 p-2 rounded-lg"
                                  ...
                                  {s.level && (
                                    <span className="text-xs px-1.5 py-0.5 rounded bg-orange-50 text-orange-600 font-medium">{s.level}</span>
                                  )}
                                </div>
                              ))}
                          </div>
                    ...
                    : filterList(detail.students, ['name', 'email', 'level', 'trade']).map((s, i) => (
                      <div key={s.id} className="flex items-center gap-3 p-3 rounded-xl hover:bg-surface-100 transition-colors"
                        ...
                        <div className="flex items-center gap-1.5 flex-shrink-0 flex-wrap justify-end">
                          {s.level && <span className="text-xs px-1.5 py-0.5 rounded bg-orange-50 text-orange-600 font-medium">{s.level}</span>}
      ...
      >
        ...
        <div>
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            {isMe && <span className="text-xs font-semibold px-1.5 py-0.5 rounded bg-orange-100 text-orange-700">You</span>}
          </div>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {isMe && (
              <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-orange-100 text-orange-700">You</span>
            )}
            <StatusBadge isActive={isActive} pulse={isActive} />
          </div>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
      ...
      <div className="w-full max-w-md rounded-2xl overflow-hidden"
        ...
        <div className="h-1 w-full" style={{ background: 'linear-gradient(90deg,#f97316,#f97316,#ec4899)' }} />
        <div className="p-6">
  ...
  return (
    <>
      ...
      <div className="space-y-5">
        ...
        {/* ── Info card ───────────────────────────────────────────────────── */}
        <div className="card" style={{ background: TOKENS.purpleGlass, borderColor: 'rgba(249,115,22,0.2)' }}>
