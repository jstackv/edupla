...
const GLOBAL_STYLES = `
  ...
  .sb-row:hover { background: rgba(194, 65, 12,0.03); }
  ...
  .sb-btn:focus-visible { outline: 2px solid #c2410c; outline-offset: 2px; }

  .sb-search input:focus { outline: 2px solid #c2410c; outline-offset: 1px; }
    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(0,0,0,0.55)', backdropFilter: 'blur(6px)', padding: 16 }}>
      <div className="sb-modal" style={{ width: '100%', maxWidth: 380, background: 'var(--card-bg)', border: '1px solid var(--card-border)', borderRadius: 20, padding: 24 }}>
        ...
        <div style={{
          ...
          <div style={{ width: 34, height: 34, borderRadius: 10, background: 'rgba(194, 65, 12,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(0,0,0,0.55)', backdropFilter: 'blur(6px)', padding: 16 }}>
      <div className="sb-modal" style={{ width: '100%', maxWidth: 400, background: 'var(--card-bg)', border: '1px solid var(--card-border)', borderRadius: 20, padding: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
          <div style={{ width: 34, height: 34, borderRadius: 10, background: 'rgba(194, 65, 12,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                background: type === opt.value ? 'rgba(194, 65, 12,0.06)' : 'var(--surface-100)',
              }}
            >
