    ...
    >
      ...
      <td style={{ padding: '10px 16px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
          <div style={{ padding: '3px 9px', borderRadius: 7, background: '#fed7aa', display: 'flex', alignItems: 'center', gap: 5 }}>
            <BookOpen size={11} style={{ color: '#c2410c' }} />
            <span style={{ fontSize: 12, fontWeight: 700, color: '#9a3412' }}>{t.class_count || 0}</span>
          </div>
        </div>
      </td>
      <td style={{ padding: '10px 16px' }}>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div className="hero-card" style={{
          ...
          <div style={{ flex: 1, minWidth: 200 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
              <div style={{ padding: '4px 10px', borderRadius: 99, background: 'rgba(194, 65, 12,0.12)', border: '1px solid rgba(194, 65, 12,0.25)', display: 'flex', alignItems: 'center', gap: 5 }}>
                ...
                <span style={{ fontSize: 10, fontWeight: 700, color: '#c2410c', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Faculty</span>
              </div>
              <div style={{ padding: '3px 8px', borderRadius: 99, background: 'rgba(194, 65, 12,0.1)', border: '1px solid rgba(194, 65, 12,0.22)', display: 'flex', alignItems: 'center', gap: 4 }}>
                ...
                <span style={{ fontSize: 10, fontWeight: 600, color: '#c2410c' }}>{total} registered</span>
              </div>
            </div>
        ...
        {/* Bottom strip */}
        <div style={{ marginTop: 18, paddingTop: 14, borderTop: '1px solid var(--hero-glass-border)', display: 'flex', gap: 20, flexWrap: 'wrap', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <BookOpen size={12} style={{ color: 'var(--hero-fg-dim)' }} />
            <span style={{ fontSize: 11, color: 'var(--hero-fg-dim)' }}>Avg classes per teacher</span>
            <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--hero-fg)' }}>
              {total > 0 ? (totalClasses / total).toFixed(1) : '—'}
            </span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <GraduationCap size={12} style={{ color: 'var(--hero-fg-dim)' }} />
            <span style={{ fontSize: 11, color: 'var(--hero-fg-dim)' }}>Avg students per teacher</span>
            <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--hero-fg)' }}>
