...
function Confetti({ accent }) {
  const colors = [accent, '#f59e0b', '#f97316', '#ec4899', '#eab308'];
  return (
        ...
        {attempt.questions.map((qq, i) => {
          ...
          return (
            <button key={qq.id} onClick={() => setCurrent(i)}
              ...
              style={{
                background: i === current ? '#f97316' : (done ? 'rgba(16,185,129,0.25)' : 'rgba(255,255,255,0.08)'),
                color: i === current ? '#fff' : (done ? '#34d399' : 'rgba(255,255,255,0.6)'),
                boxShadow: i === current ? '0 4px 12px rgba(249,115,22,0.45)' : 'none',
              }}>{i + 1}</button>
          );
        })}
      </div>
              ...
              {q.options.map(opt => {
                ...
                return (
                  <button key={opt.key}
                    ...
                    style={{ borderColor: selected ? '#f97316' : 'rgba(255,255,255,0.15)', background: selected ? 'rgba(249,115,22,0.15)' : 'rgba(255,255,255,0.04)', color: '#fff', boxShadow: selected ? '0 6px 18px rgba(249,115,22,0.25)' : 'none' }}>
                    <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 transition-transform duration-200" style={{ background: selected ? '#f97316' : 'rgba(255,255,255,0.1)', transform: selected ? 'scale(1.1)' : 'scale(1)' }}>{opt.key}</span>
                    {opt.text}
                  </button>
                );
              })}
            ...
            <div className="flex gap-3">
              {['true', 'false'].map(v => (
                <button key={v} onClick={() => saveAnswer(q.id, v)}
                  ...
                  style={{ borderColor: answers[q.id] === v ? '#f97316' : 'rgba(255,255,255,0.15)', background: answers[q.id] === v ? 'rgba(249,115,22,0.15)' : 'rgba(255,255,255,0.04)', color: '#fff', boxShadow: answers[q.id] === v ? '0 6px 18px rgba(249,115,22,0.25)' : 'none' }}>
                  {v}
                </button>
              ))}
            </div>
