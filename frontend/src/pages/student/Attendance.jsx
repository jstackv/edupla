...
import {
  ...
  Flame, TrendingUp, TrendingDown, Minus, Printer, FileBarChart2, History,
} from 'lucide-react';
...
function TrendBadge({ trend }) {
  ...
  return (
    <span className="inline-flex items-center gap-1 text-xs font-semibold badge" style={{ background: up ? 'rgba(16,185,129,0.12)' : 'rgba(239,68,68,0.12)', color }}>
                  ...
                  <div className="flex-1 text-center sm:text-left space-y-2">
                    ...
                    <div className="flex items-center gap-2 justify-center sm:justify-start flex-wrap">
                      ...
                      {report.current_streak > 0 && (
                        <span className="inline-flex items-center gap-1 text-xs font-semibold badge" style={{ background: 'rgba(249,115,22,0.12)', color: '#f97316' }}>
                    ...
                    <div className="flex gap-2 justify-center sm:justify-start flex-wrap pt-1">
                      {Object.entries(STATUS_META).map(([key, meta]) => (
                        <span key={key} className="text-xs badge" style={{ background: meta.bg, color: meta.color }}>
              ...
              <div>
                ...
                {report.current.days.length === 0 ? (
                  ...
                  <div className="relative pl-6">
                    <div className="absolute left-[7px] top-2 bottom-2 w-px" style={{ background: 'var(--border-color)' }} />
                      ...
                      {report.current.days.map((d, i) => {
                        ...
                        return (
                          <div key={i} className="relative">
                            <div className="absolute -left-6 top-0.5 w-3.5 h-3.5 rounded-full border-2"
